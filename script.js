document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('blur', function (e) {
    ...
    if (!field.matches('.contact-form input, .contact-form textarea, .contact-form select')) return;

    const form = field.closest('.contact-form');
    if (!form) return;

    const existingError = form.querySelector('#' + ((field.id || field.name || 'field') + '-error'));
  ...
  // RTL support: ensure scroll direction is handled correctly
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '9d2be883-5fe3-4184-9f46-7f3341d3ecda',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '9d2be883-5fe3-4184-9f46-7f3341d3ecda';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 0503737557 placeholder which businessInfoUpdater can replace
...
(function () {
  // Show play button ripple on click and simulate play feedback
  const cards = document.querySelectorAll('.vg-card');

  cards.forEach(function (card) {
    const playBtn = card.querySelector('.vg-play-btn');
    ...
    playBtn.addEventListener('click', function (e) {
      ...
      playBtn.style.transition = 'transform 0.15s ease, box-shadow 0.15s ease';
    ...
    // Keyboard accessibility: Enter/Space on card triggers play
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9d2be883-5fe3-4184-9f46-7f3341d3ecda';
